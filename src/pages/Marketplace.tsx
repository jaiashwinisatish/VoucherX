        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {vouchers.map((voucher) => {
            ...
            return (
              <div
                key={voucher.id}
                className="bg-white/80 backdrop-blur-sm rounded-xl border border-slate-200 cursor-pointer hover:shadow-xl hover:scale-[1.03] hover:-translate-y-1 transition-all duration-300 overflow-hidden group"
              >
