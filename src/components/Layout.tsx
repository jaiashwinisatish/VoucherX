        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center min-h-16 py-2 gap-2">
            <div className="flex items-center gap-3 lg:gap-8 min-w-0">
              ...
              <div className="hidden md:flex items-center md:flex-wrap lg:flex-nowrap gap-1 lg:gap-2 min-w-0">
                {navItems.map(item => {
                  ...
                  return (
                    <button
                      ...
                      title={item.label}
                      className={`px-2.5 py-2 lg:px-4 rounded-lg flex items-center space-x-1.5 lg:space-x-2 transition-all ${isActive
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="hidden md:flex lg:hidden items-center space-x-1">
                <button
                  ...
                  className="flex items-center justify-center w-10 h-10 hover:bg-slate-100 rounded-full transition-colors"
                  aria-label="Profile"
                  title="Profile"
                >
